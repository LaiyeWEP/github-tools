...
class GiteaToolsTool(Tool):
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage]:
        ...
        try:
            ...
            # Gitea API endpoint for creating a comment on a pull request
            url = f"{gitea_api_url}/api/v1/repos/{owner}/{repo}/issues/{mr_number}/comments"
            ...
            yield self.create_text_message(f"Error adding comment to MR: {str(e)}")
